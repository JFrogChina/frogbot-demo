...
![](2024-05-08-14-02-44.png)

## 2.Download maven project and copy to your  project of frogbot-scan 
```
git clone git@github.com:JFrogChina/frogbot.git (your project address)
unzip project-examples-master.zip
mv project-examples-master/maven-examples/maven-example/*
/Users/hailangz/test/frogbot
```

## 3.Add yml
```
cd /Users/hailangz/test/frogbot
mkdir -pv .github/workflows
vim frogbot-scan-pull-request.yml
```
```
...
```
```
vim frogbot-scan-repository.yml
...
## 5.config Variables
![](2024-05-08-14-05-29.png)

## 6.Run  CI
![](2024-05-08-14-05-58.png)


## 7.Check result
![](2024-05-08-14-06-27.png)
![](2024-05-08-14-06-57.png)
![](2024-05-08-14-07-15.png)